...
a2b <- read.csv("./notebooks/data/address_units_to_blocks.csv.gz", header = TRUE)

## BBLS to blocks

Bbls <- read.csv("./notebooks/data/bbls_to_blocks.csv.gz", header = TRUE)

## Cama to blocks

Cama <- read.csv("./notebooks/data/cama_to_blocks.csv.gz", header = TRUE)


## Environment features

Env_features <- read.csv("./notebooks/data/env_features.csv.gz", header = TRUE)

## Field validation outcomes
Field_validation <- read.csv("./notebooks/data/field_validation_outcomes.csv", header = TRUE)

## Final address
Final_address <- read.csv("./notebooks/data/final_address_to_block_0.csv.gz", header = TRUE)

## Impervious surfaces
Impervious_surfaces <- read.csv("./notebooks/data/impervious_surfaces.csv.gz", header = TRUE)

## Permits to blocks
Permits2blocks <- read.csv("./notebooks/data/permits_to_blocks.csv.gz", header = TRUE)
...
## Census blocks
Census_blocks <- st_read("./notebooks/data/Census_Blocks__2010.geojson") %>%
  st_transform('ESRI:102685')
