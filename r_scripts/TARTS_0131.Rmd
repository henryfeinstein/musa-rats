...
Data311_16 <- st_read("C:/Users/henry/Documents/HFdocs/Penn/Spring_2023/MUSA7900_Practicum/311_City_Service_Requests_in_2016.geojson") %>% 
...
## Public Trash Cans
trash_cans <- read_csv("./data/Litter_Cans.csv") %>%
  st_as_sf(., coords = c("X", "Y"), crs = 4326, agr = "constant") %>%
  st_transform('ESRI:102685')
...
sewer_grates <- read_csv("./data/Sidewalk_Grates_2019.csv") %>%
  st_as_sf(., coords = c("X", "Y"), crs = 4326, agr = "constant") %>%
  st_transform('ESRI:102685')
...
block_dat <- st_join(block_dat, Ward)
```
...
block_311_join <- st_join(blocks, Data311_16)
