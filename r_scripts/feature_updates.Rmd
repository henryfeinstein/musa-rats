...
```{r setup, r message=FALSE, warning=FALSE, include=FALSE}
...
imp_surfaces <- read.csv("./data/Impervious_Surface_2015.csv", header = TRUE)

## Public Trash Cans
trash_cans <- read.csv("./data/Litter_Cans.csv", header = TRUE)

## National Parks
nat_parks <- read.csv("./data/National_Parks.csv", header = TRUE)

## Parks and Rec Parks
dc_parks <- read.csv("./data/Parks_and_Recreation_Areas.csv", header = TRUE)
...
## Urban Ag Area
urban_ag <- read.csv("./data/Urban_Agriculture_Areas.csv", header = TRUE)

## Zoning Map
zoning <- read.csv("./data/Zoning_Regulations_of_2016.csv", header = TRUE)
```
